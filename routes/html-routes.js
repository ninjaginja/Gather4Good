...
router.get("/", function(req, res) {
    res.sendFile(path.join(_dirname, "../public/test.html")); //*UPDATE* with correct landing-page html
});
...
router.get("/create", function(req, res) {
    res.sendFile(path.join(_dirname, "../public/test2.html")); //*UPDATE* with correct create-event html
});
